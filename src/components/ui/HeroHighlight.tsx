...
export const Highlight = ({
  ...
  return (
    <motion.span
      ...
      className={cn(
        `relative inline-block pb-1 px-2 rounded-lg bg-gradient-to-r from-sky-500/30 to-indigo-500/30 dark:from-sky-500/40 dark:to-indigo-500/40 border border-sky-500/20`,
        className
      )}
    >
      {children}
